          ...
          {selected && (
            <div className="space-y-4 text-sm">
              <div className="grid grid-cols-2 gap-2">
                ...
                <div><span className="text-muted-foreground">客户：</span>{selected.shipping_name}</div>
                <div><span className="text-muted-foreground">邮箱：</span>{selected.shipping_email}</div>
                <div><span className="text-muted-foreground">总额：</span>NZ${Number(selected.total || 0).toFixed(2)}</div>
